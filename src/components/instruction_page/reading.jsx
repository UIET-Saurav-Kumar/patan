...
const Reading = () => {
    ...
    const handleClick = ()=>
    {
        if(check)
        {
            router.push("/jee_mains_paper/front_layout")
        }
        else
        {
    ...
    return ( <div className="ml-20">
        ...
        <div>
            ...
            <ol className="ml-10 mt-3 text-[18px]  mr-10">
                ...
                <li>6. You can click on  to navigate to the bottom and  to navigate to top of the question are, without scrolling.</li>
            </ol>
        </div>
...
<ol className="ml-10 mt-3 text-[18px]  mr-10">
    <li>8. Procedure for answering a multiple choice type question:</li>
        ...
        <ol className="ml-10 ">
            ...
            <li className=" flex items-center ">b. To deselect your chosen answer, click on the button of the chosen option again or click on the <strong>Clear Response</strong> button
...
<input type="checkbox" onClick={()=>{check = !check}} className="mr-2"/> 
